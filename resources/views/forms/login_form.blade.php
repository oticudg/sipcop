...
<div id="modal1" class="modal modal-fixed-footer modalback">
	<div class="modal-content">
		...
		<div class="container-login center-align">
			...
			<div style="">
				<h1 class="light-blue-text"> <i class="zmdi zmdi-account-circle animated animatedicon pulse"></i> </h1>
			...
			<form action="{{ url('/login') }}" method="post">
				...
				@endif
				<button class="waves-effect waves-teal cyan btn z-depth-1 tooltipped" data-tooltip="Presione para ingresar">Ingresar &nbsp; <i class="zmdi zmdi-mail-send"></i></button>
